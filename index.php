...
$brokenShip = new BrokenShip("Bork");

$ships[] = $brokenShip;

// Because of the interfaces we added,
// we are able to call methods on something that looks
// and acts like and array.
                ...
                <div>
                    <form method="POST" action="battle.php">
                        ...
                        <div class="text-center">
                          <label for="battle_typ">Battle Type</label>
                          <select name="battle_type" id="battle_type" class="center-block form-control btn drp-dwn-width btn-default btn-lg dropdown-toggle">
                            <?php foreach ($battleTypes as $battyleType => $typeText) :?>
                            <option value="<?php echo $battyleType?>"><?php echo $typeText?></option>
                            <?php endforeach ?>
                          </select>
                        </div>
